...
!define Version "1.1.7.2"
!define Game "Monster RPG 3"
!define ExeName "MonsterRPG3"
!define GameExeName "Monster RPG 3"
...
!else
  ...
  !system "$\"${NSISDIR}\makensis$\" /DINNER C:\Users\Trent\code\Monster_RPG_3\installer.nsi" = 0
  ...
  !system "signtool sign /f C:\Users\Trent\Documents\codesign-2018-2019.pfx /p FIXME /tr http://timestamp.comodoca.com/rfc3161 /td sha1 $%TEMP%\Uninstall.exe" = 0
  !system "signtool sign /f C:\Users\Trent\Documents\codesign-2018-2019.pfx /p FIXME /fd sha256 /tr http://timestamp.comodoca.com/rfc3161?td=sha256 /td sha256 /as $%TEMP%\Uninstall.exe" = 0
...
;Interface Settings
  ...
  !define MUI_WELCOMEFINISHPAGE_BITMAP "origdata\icons\windows\win32_installer_logo.bmp"
  ;!define MUI_HEADERIMAGE_BITMAP "origdata\icons\windows\installer_head_logo.bmp"
  !define MUI_ICON "origdata\icons\windows\install.ico"
  !define MUI_UNICON "origdata\icons\windows\uninstall.ico"
...
;Pages
  ...
  !define MUI_FINISHPAGE_RUN "$INSTDIR\${GameExeName}.exe"
...
;Reserve Files
  ...
  ReserveFile "${NSISDIR}\Plugins\x86-unicode\*.dll"
...
!endif
  ...
  CreateShortCut "$SMPROGRAMS\$StartMenuFolder\${Game}.lnk" "$INSTDIR\${GameExeName}.exe"
  ...
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\${Game} ${Version}" "DisplayIcon" "$INSTDIR\${GameExeName}.exe,0"
  ...
  WriteRegDWORD SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\${Game} ${Version}" "EstimatedSize" 4000
...
Section /o "Desktop Shortcut" DesktopShortcutSection
  ...
  CreateShortCut "$DESKTOP\${Game}.lnk" "$INSTDIR\${GameExeName}.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\3rd_party.html"
  Delete "$INSTDIR\data.cpa"
  Delete "$INSTDIR\FamilyLicense.txt"
  Delete "$INSTDIR\manual_english.html"
  Delete "$INSTDIR\manual_french.html"
  Delete "$INSTDIR\${GameExeName}.exe"
