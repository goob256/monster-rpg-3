...
if "%1"=="d" goto data
:tgui3
cd c:\users\trent\code\tgui3\build
...
goto done
:monster_rpg_3
cd c:\users\trent\code\Monster_RPG_3\build
...
xcopy /e /y ..\Monster_RPG_3\data data\
copy "..\Monster_RPG_3\docs\3rd_party.html" .
goto done
:data_release
cd c:\users\trent\code\Monster_RPG_3\data
c:\users\trent\code\compress_dir\compress_dir.exe
move ..\data.cpa c:\users\trent\code\m3
copy "c:\users\trent\code\Monster_RPG_3\docs\3rd_party.html" c:\users\trent\code\m3
goto done
:done
endlocal
popd
