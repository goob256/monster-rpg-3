...
#ifdef NOOSKEWL_SHIM_STATIC
#define NOOSKEWL_SHIM_EXPORT
#else
#ifdef NOOSKEWL_SHIM_BUILD
#define NOOSKEWL_SHIM_EXPORT __declspec(dllexport)
#else
#define NOOSKEWL_SHIM_EXPORT __declspec(dllimport)
#endif
#endif

#define EXPORT_STRUCT_ALIGN(x, n) __declspec(align(n)) struct NOOSKEWL_SHIM_EXPORT x
#define EXPORT_CLASS_ALIGN(x, n) __declspec(align(n)) class NOOSKEWL_SHIM_EXPORT x
...
extern glStencilFuncSeparate_func glStencilFuncSeparate_ptr;
extern glStencilOpSeparate_func glStencilOpSeparate_ptr;
extern glBindFramebuffer_func glBindFramebuffer_ptr;
extern glDeleteRenderbuffers_func glDeleteRenderbuffers_ptr;
extern glGenFramebuffers_func glGenFramebuffers_ptr;
extern glGenRenderbuffers_func glGenRenderbuffers_ptr;
extern glBindRenderbuffer_func glBindRenderbuffer_ptr;
extern glFramebufferTexture2D_func glFramebufferTexture2D_ptr;
extern glRenderbufferStorage_func glRenderbufferStorage_ptr;
extern glCheckFramebufferStatus_func glCheckFramebufferStatus_ptr;
extern glDeleteFramebuffers_func glDeleteFramebuffers_ptr;
extern glFramebufferRenderbuffer_func glFramebufferRenderbuffer_ptr;
extern glUseProgram_func glUseProgram_ptr;
extern glUniform1f_func glUniform1f_ptr;
extern glUniform2f_func glUniform2f_ptr;
extern glUniform3f_func glUniform3f_ptr;
extern glUniform4f_func glUniform4f_ptr;
extern glUniform1i_func glUniform1i_ptr;
extern glUniform2i_func glUniform2i_ptr;
extern glUniform3i_func glUniform3i_ptr;
extern glUniform4i_func glUniform4i_ptr;
extern glUniform1fv_func glUniform1fv_ptr;
extern glUniform2fv_func glUniform2fv_ptr;
extern glUniform3fv_func glUniform3fv_ptr;
extern glUniform4fv_func glUniform4fv_ptr;
extern glUniform1iv_func glUniform1iv_ptr;
extern glUniform2iv_func glUniform2iv_ptr;
extern glUniform3iv_func glUniform3iv_ptr;
extern glUniform4iv_func glUniform4iv_ptr;
extern glUniformMatrix2fv_func glUniformMatrix2fv_ptr;
extern glUniformMatrix3fv_func glUniformMatrix3fv_ptr;
extern glUniformMatrix4fv_func glUniformMatrix4fv_ptr;
extern glDeleteShader_func glDeleteShader_ptr;
extern glCreateProgram_func glCreateProgram_ptr;
extern glDeleteProgram_func glDeleteProgram_ptr;
extern glAttachShader_func glAttachShader_ptr;
extern glLinkProgram_func glLinkProgram_ptr;
extern glGetAttribLocation_func glGetAttribLocation_ptr;
extern glEnableVertexAttribArray_func glEnableVertexAttribArray_ptr;
extern glVertexAttribPointer_func glVertexAttribPointer_ptr;
extern glGetUniformLocation_func glGetUniformLocation_ptr;
extern glShaderSource_func glShaderSource_ptr;
extern glCompileShader_func glCompileShader_ptr;
extern glGetShaderiv_func glGetShaderiv_ptr;
extern glGetShaderInfoLog_func glGetShaderInfoLog_ptr;
extern glCreateShader_func glCreateShader_ptr;
extern glBlendFunc_func glBlendFunc_ptr;
extern glEnable_func glEnable_ptr;
extern glDisable_func glDisable_ptr;
extern glFrontFace_func glFrontFace_ptr;
extern glCullFace_func glCullFace_ptr;
extern glScissor_func glScissor_ptr;
extern glViewport_func glViewport_ptr;
extern glClearColor_func glClearColor_ptr;
extern glClear_func glClear_ptr;
extern glClearDepthf_func glClearDepthf_ptr;
#if !defined ANDROID && !defined IOS
extern glClearDepth_func glClearDepth_ptr;
#endif
extern glClearStencil_func glClearStencil_ptr;
extern glDepthMask_func glDepthMask_ptr;
extern glDepthFunc_func glDepthFunc_ptr;
extern glStencilFunc_func glStencilFunc_ptr;
extern glStencilOp_func glStencilOp_ptr;
extern glStencilFuncSeparate_func glStencilFuncSeparate_ptr;
extern glActiveTexture_func glActiveTexture_ptr;
extern glColorMask_func glColorMask_ptr;
extern glDeleteTextures_func glDeleteTextures_ptr;
extern glGenTextures_func glGenTextures_ptr;
extern glBindTexture_func glBindTexture_ptr;
extern glTexImage2D_func glTexImage2D_ptr;
extern glTexParameteri_func glTexParameteri_ptr;
extern glGetError_func glGetError_ptr;
extern glDrawArrays_func glDrawArrays_ptr;
#endif
...
#if defined STEAMWORKS && defined __linux__
#include <SDL2/SDL.h>
...
#include "Nooskewl_Shim/basic_types.h"
