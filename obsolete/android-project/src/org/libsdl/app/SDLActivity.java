...
public class SDLActivity extends Activity {
    ...
    {
      int orientation = -1;
      boolean set_unspecified = false; // SCREEN_ORIENTATION_UNSPECIFIED is -1 also

      if (hint != "") {
         if (hint.contains("LandscapeRight") && hint.contains("LandscapeLeft") &&
             hint.contains("Portrait") && hint.contains("PortraitUpsideDown")) {
	    orientation = ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED;
	    set_unspecified = true;
         } else if (hint.contains("LandscapeRight") && hint.contains("LandscapeLeft")) {
      ...
      /* no valid hint */
      if (orientation == -1 && !set_unspecified) {
         if (resizable) {
   ...
   public static void init_joystick()
   {
    ...
    public static void shutdown_joystick() {
        mJoystickHandler = null;
	mHapticHandler = null;
	}
